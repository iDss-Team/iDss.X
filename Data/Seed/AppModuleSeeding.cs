...
namespace iDss.X.Data.Seed
{
    public static class AppModuleSeeding
    {
        ...
        public static void SeedAppModule(this ModelBuilder modelBuilder)
        {
            ...
            new() { moduleid = "113", modulename = "Cash on Delivery", description = "Handles cash payments upon delivery, including transaction recording and coordination with couriers.", modulesort = 13, modulectgid = 5, icon = "fa-solid fa-money-bill-wave", flag = 1, createddate = new DateTime(2025, 1, 1), createdby = "System" },
