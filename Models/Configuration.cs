...
namespace iDss.X.Models
{
    public class AppModuleCtg : CommonField1
    {
        ...
        [StringLength(50)] public String modulectgname { get; set; }

        public int modulectgsort { get; set; }

        [ValidateNever] public virtual ICollection<AppModule> Modules { get; set; } = new List<AppModule>();

    }

    public class AppModule : CommonField2
    {
        [Key][StringLength(5)] public String moduleid { get; set; }

        [StringLength(30)] public String modulename { get; set; }

        public String? description { get; set; }

        public int modulesort { get; set; }

        [ValidateNever][Required][Display(Name = "Module Category")] public int modulectgid { get; set; }
        [ForeignKey("modulectgid")][ValidateNever] public AppModuleCtg ModuleCtg { get; set; }

        [StringLength(50)] public String? icon { get; set; }

        [ValidateNever] public virtual ICollection<AppMenu> Menus { get; set; } = new List<AppMenu>();
